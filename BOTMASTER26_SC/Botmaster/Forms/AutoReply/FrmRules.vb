...
Public Class FrmRules
    ...
    Private Sub ButtonOK_Click(sender As Object, e As EventArgs) Handles ButtonOK.Click
        ...
        _autoReplyObject.ButtonsFile = TextBox2.Text
    ...
    Private Sub FrmAutoReply_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not IsNothing(Rule) Then
            Try
                ...
                TextBox1.Text = Rule.CatalogFile
                TextBox2.Text = Rule.ButtonsFile
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        dlg.Filter = "*.rule|*.rule"
        If dlg.ShowDialog() = DialogResult.OK Then
            IO.File.WriteAllText(dlg.FileName, JsonConvert.SerializeObject(Rule))
        End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        Dim dlg As New OpenFileDialog
        dlg.Filter = "*.rule|*.rule"
        Dim ImportedRule As Object = Nothing
        If dlg.ShowDialog() = DialogResult.OK Then
            ImportedRule = JsonConvert.DeserializeObject(Of ClsRuleModel)(IO.File.ReadAllText(dlg.FileName))
        End If
        If Not IsNothing(ImportedRule) Then
            Try

                TextBoxRuleName.Text = ImportedRule.RuleName
                ComboBox1.Text = ImportedRule.Operand
                TextBoxKeyword.Text = ImportedRule.RuleKeyword
                TextBoxMessage.Text = ImportedRule.RuleMessage
                CheckBoxEnable.Checked = CBool(ImportedRule.RuleStatus)
                TextBox1.Text = ImportedRule.CatalogFile
                TextBox2.Text = ImportedRule.ButtonsFile
                Dim t As ClsAttachment
                Dim li As ListViewItem
                ListViewAttachment.Items.Clear()

                If Not IsNothing(ImportedRule.Attachment) Then
                    For Each t In ImportedRule.Attachment
                        li = New ListViewItem
                        li.Text = t.FileName
                        li.Tag = t.File
                        li.SubItems.Add(t.MediaType)
