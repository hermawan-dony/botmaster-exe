<?php
    ...
    $t = [
        'id' => [
            ...
            'feat_2' => 'Sistem Proteksi Anti-Banned',
            ...
            'ben_2_title' => '🛡️ Sistem Proteksi Anti-Banned',
            'ben_2_desc' => 'Kirim pesan dengan aman tanpa khawatir terblokir! Dilengkapi dengan setelan jeda dinamis (delay acak) dan fitur siklus istirahat (sleep engine) otomatis sesuai standar pengiriman humanis.',
        ...
        'en' => [
            ...
            'feat_1' => 'WAGW ODBC Auto-Sync (NEW!)',
            'feat_2' => 'Anti-Banned Protection System',
            ...
            'guarantee' => 'Free Lifetime Updates During Active Period',
            'chat_telegram' => 'Chat Support via Telegram',
            'chat_whatsapp' => 'Chat Support via WhatsApp',
            'stat_1' => 'Read Rate (Open Rate)',
            'stat_2' => 'Faster & Efficient',
            'stat_3' => 'No Cut From Monthly Cost',
            'why_title' => 'Turn Your WhatsApp Into A Money Maker',
            'why_desc' => 'Fact: 80% of online shoppers in Indonesia prefer transacting via WhatsApp. This is a MUST-have marketing tool for Business Owners, Dropshippers, and Affiliates to maximize profit.',
            'ben_1_title' => '🚀 WAGW ODBC Database Auto-Sync (NEW!)',
            'ben_1_desc' => 'Turn Botmaster into a 24/7 Gateway (Multi-Database Ready)! The system runs stealthily in the background and reads your outbox table via MySQL, SQL Server, or ODBC. Just INSERT SQL, auto-send Text & Rich Media (Image/File)!',
            'ben_2_title' => '🛡️ Anti-Banned Protection System',
            'ben_2_desc' => 'Send messages safely without worrying about bans! Equipped with dynamic delays (random delay) and auto-sleep cycle features matching humanist sending behavior.',
