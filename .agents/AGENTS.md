...
13. **Help Menu & Tutorial**: For WAGW users, hide the 'About' and 'Check for Update' menu items under the Help menu. The WAGW Tutorial must open in a custom scrollable Form containing a RichTextBox rather than a MsgBox.
